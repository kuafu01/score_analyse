...
def insert_test_data():
    ...
    # 8. 学习报告
    reports = [
        ('rp0001', 's0001', 't0001', '2025-04-15', '语文基础扎实，作文表达能力突出，需加强文言文阅读', 'A'),
        ('rp0002', 's0001', 't0002', '2025-04-16', '数学逻辑思维强，解题速度快，但需注意计算细节', 'A'),
        ('rp0003', 's0005', 't0005', '2025-06-25', '化学实验操作规范，但理论知识掌握不牢固', 'B'),
        ('rp0004', 's0008', 't0003', '2025-06-26', '英语口语流利，但语法错误较多，需加强练习', 'B'),
        ('rp0005', 's0010', 't0010', '2025-06-27', '体育成绩优秀，篮球特长突出，建议发展专项', 'A'),
        ('rp0006', 's0002', 't0001', '2025-04-17', '阅读理解能力强，但作文结构需优化', 'B'),
        ('rp0007', 's0003', 't0002', '2025-04-18', '数学基础良好，应用题解题能力需提高', 'B')
    ]
